...
@Composable
fun GroupMembersAdminPage(navController: NavController){
    GroupMembersAdminScreen(navController)
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun GroupMembersAdminScreen(
    ...
    Card(
        ...
        Row(
            ...
            Box (
                ...
                Image(
                    painter = painterResource(id = R.drawable.delete_member),
                    contentDescription = null,
                    modifier = Modifier
                        .size(35.dp),
