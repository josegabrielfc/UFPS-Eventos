...
@Composable
fun GroupSubscribePage(navController: NavController, modifier: Modifier = Modifier) {
    GroupSubscribeScreen(navController = navController)
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun GroupSubscribeScreen(navController: NavController,
    ...
    Column(
        ...
        Button(
            ...
            Text("Suscribirse al Grupo", color = Color.White)
        }
    }
}
